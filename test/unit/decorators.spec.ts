...
describe("@Inject decorator", () => {
	...
	it("can not be used on classes directly", () => {
		...
		expect(testFunction).toThrow(
			new TypeError("Invalid @Inject Decorator declaration."),
		);
	});
});
...
describe("@InjectValue decorator", () => {
	...
	it("should inject a new value on the property field", () => {
		...
		expect(mockInjectValueProperty).toHaveBeenCalledWith(
			SimppleInject,
			"dateProperty",
			"myDate",
		);
	...
	it("can not be used on classes directly", () => {
		...
		expect(testFunction).toThrow(
			new TypeError("Invalid @InjectValue Decorator declaration."),
		);
	});
});
