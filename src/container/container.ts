import { BuildContext, Namespace, Snapshot } from "../model";
import {
	IoCBindConfig,
	IoCBindValueConfig,
	PropertyPath,
} from "./container-binding-config";
...
export class IoCContainer {
	...
	public static injectValueProperty(
		target: Function,
		key: string,
		name: string,
	) {
